...
# Builds and (re)starts the app container on 127.0.0.1:8000 — the VM's existing nginx
# (already fronting another backend) reverse-proxies the staging subdomain to it.
...
echo "Deployed. App listening on 127.0.0.1:8000. Tail logs with:"
